...
public class LinkedList<T> implements Iterable<T> {
    ...
    public <R> LinkedList<R> map(Function<T, R> mapper) {
        ...
        LinkedList<R> mappedLinkedList = new LinkedList<>();

        for (T data : this) {

            mappedLinkedList.add(mapper.apply(data));
    ...
    public LinkedList<T> filter(Predicate<T> predicate) {
        ...
        LinkedList<T> filteredLinkedList = new LinkedList<>();

        for (T data : this) {

            if (predicate.test(data)) {

                filteredLinkedList.add(data);
